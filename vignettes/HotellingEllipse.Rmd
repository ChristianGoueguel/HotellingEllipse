...
This package is specifically designed to help draw the Hotelling's T-squared ellipses on the PCA or PLS score scatterplot. It computes the Hotelling’s T-squared statistic, the semi-minor axis, the semi-major axis along with the coordinate points for drawing a confidence ellipse based on Hotelling’s T-squared statistic. Specifically, there are two functions available:
...
## Calculate using a cumulative variance threshold 
