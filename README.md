...
We want to compute the parameters of the ellipses semiminor and semimajor axes when the first principal component, PC1 (pcx = 1), is on the *x*-axis and, the second principal component, PC2 (pcy = 2), is on the *y*-axis.  
