...
**Step 5.** Run `HotellingEllipse()` for the first two principal components (k = 2). We want to compute the principal axes of the ellipses (denoted **a** and **b**) when the first principal component, PC1 (pcx = 1), is on the *x*-axis and, the second principal component, PC2 (pcy = 2), is on the *y*-axis.
