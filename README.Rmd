...
[![Codecov test coverage](https://codecov.io/gh/ChristianGoueguel/HotellingEllipse/branch/master/graph/badge.svg)](https://app.codecov.io/gh/ChristianGoueguel/HotellingEllipse?branch=master)
[![Lifecycle:
...
-   with `ellipseParam()` we get the T$^2$ value along with the values
    of the semi-minor and semi-major axes. Whereas, `ellipseCoord()`
...
the 99% and 95% confidence intervals for T$^2$.
...
**Note:** The easiest way to analyze and interpret Hotelling’s T$^2$ for
more than two principal components, is to plot Hotelling’s T$^2$ *vs.*
Observations, where the confidence limits are plotted as a line. Thus,
observations below the two lines are within the T$^2$ limits. For
